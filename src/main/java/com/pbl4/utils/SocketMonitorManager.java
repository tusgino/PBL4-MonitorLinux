        ...
        try {
            ...
            while ((socketLine = input.readLine()) != null) {
                ...
                socketMonitor.setSend_Q(Long.parseLong(socketsInfos[3]));
                {
                    ...
                    // System.out.println(addressInfo[0] + "\t\t" + Integer.parseInt(addressInfo[1])
                    // + "\t\t" + "*".equals(addressInfo[1]));
...

                {
                    ...
                    socketMonitor
                            .setPeerPort(Integer.parseInt(addressInfo[1].trim().equals("*") ? "0" : addressInfo[1]));
                }
